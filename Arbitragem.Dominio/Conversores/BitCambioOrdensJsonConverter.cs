...
{
    public class BitCambioOrdensJsonConverter : JsonConverter<IEnumerable<Ordem>>
    {
        ...
        public override IEnumerable<Ordem> ReadJson(JsonReader reader, Type objectType,
            IEnumerable<Ordem> existingValue, bool hasExistingValue,
